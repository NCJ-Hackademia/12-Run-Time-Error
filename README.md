...
# Hackademia 2025 – Run Time Error

Welcome to the official repository for **Hackademia 2025 – Run Time Error**, part of the national-level hackathon hosted by **National College Jayanagar**.  
...
## **Team Information**
- **Team Name:** Run Time Error  
- **Team Captain (GitHub):** [@mysteryisfun](https://github.com/mysteryisfun)  
- **Repository Name:** 12-Run-Time-Error  
